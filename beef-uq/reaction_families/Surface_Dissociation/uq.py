...
alpha_1=alpha_1_ref+Delta_alpha[:,18]
E0_1=E0_1_ref+Delta_E0[:,19]
alpha_2=alpha_2_ref+Delta_alpha[:,20]
E0_2=E0_2_ref+Delta_E0[:,21]
alpha_3=alpha_3_ref+Delta_alpha[:,22]
E0_3=E0_3_ref+Delta_E0[:,23]
alpha_4=alpha_4_ref+Delta_alpha[:,24]
E0_4=E0_4_ref+Delta_E0[:,25]
alpha_5=alpha_5_ref+Delta_alpha[:,26]
E0_5=E0_5_ref+Delta_E0[:,27]
alpha_6=alpha_6_ref+Delta_alpha[:,28]
E0_6=E0_6_ref+Delta_E0[:,29]
alpha_7=alpha_7_ref+Delta_alpha[:,22]
E0_7=E0_7_ref+Delta_E0[:,23]
alpha_8=alpha_8_ref+Delta_alpha[:,22]
E0_8=E0_8_ref+Delta_E0[:,23]
alpha_9=alpha_9_ref+Delta_alpha[:,22]
E0_9=E0_9_ref+Delta_E0[:,23]
alpha_10=alpha_10_ref+Delta_alpha[:,22]
E0_10=E0_10_ref+Delta_E0[:,23]
alpha_11=alpha_11_ref+Delta_alpha[:,30]
E0_11=E0_11_ref+Delta_E0[:,31]
    ...
    for line in s:                   
      if "    index = 11" in line:
          ...
          for line in s:
              if line.startswith("        alpha ="):
                   old=line.strip()
                   modified="".join(("alpha =",str(np.round(float(alpha_11[i]),2)), ","))
                   new_line=line.replace(old,modified)
                   new_file_content += new_line
              elif line.startswith("        E0 = ("):     
                   old=line.strip()
                   modified="".join(("E0 = (",str(np.round(float(E0_11[i]),2)), ", 'kJ/mol'),"))
                   new_line=line.replace(old,modified)
                   new_file_content += new_line                         
              else:
                   old=line.strip()
